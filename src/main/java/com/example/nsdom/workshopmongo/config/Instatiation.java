package com.example.nsdom.workshopmongo.config;
...
import com.example.nsdom.workshopmongo.dto.AuthorDTO;
import com.example.nsdom.workshopmongo.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Parti em viagem", "Vou viajar para Paris. Abraços!",new AuthorDTO(maria));
